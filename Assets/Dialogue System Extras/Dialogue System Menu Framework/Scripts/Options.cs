...
namespace PixelCrushers.DialogueSystem.MenuSystem
{
    ...
    public class Options : MonoBehaviour
    {
        ...
        public virtual void SetSeLevel(float seLevel)
        {
            ...
            if (mainMixer != null)
            {
                float volumeBase = seLevel == seVolumeSlider.minValue ? 0f : 1f;
                SystemFacade.instance.SetSeAudioSourceVolume(volumeBase);
        ...
        public virtual void SetVoiceLevel(float voiceLevel)
        {
            ...
            if (mainMixer != null)
            {
                ...
                SystemFacade.instance.SetVoiceAudioSourceVolume(volumeBase);
