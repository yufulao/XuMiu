...
namespace PixelCrushers.DialogueSystem.MenuSystem
{
    ...
    public class SaveHelper : MonoBehaviour
    {
        ...
        public string firstGameplayScene = "Game";
        ...
        public void EnterStage(StageData.StageDataEntry stageData)
        {
            if (HasLastSavedGame())
            {
            ...
            //SystemFacade.instance.StageGameStart(stageData);
        }
        ...
        public virtual void RestartGame()//开始游戏
        {
        ...
        public virtual void LoadGame(int slotNum)//继续游戏
        {
            LoadGameNow(slotNum);
        }
